...
<audio id="notifikasi_in">
    <source src="{{ asset('public/assets/sound/notifikasi_in.mp3') }}" type="audio/mpeg">
</audio>
<audio id="notifikasi_out">
    <source src="{{ asset('public/assets/sound/notifikasi_out.mp3') }}" type="audio/mpeg">
</audio>
<audio id="notifikasi_radius">
    <source src="{{ asset('public/assets/sound/notifikasi_radius.mp3') }}" type="audio/mpeg">
</audio>
@endsection
...
<script>
    ...
    function successCallback(position) {
        ...
        var circle = L.circle([-7.946397116561939, 112.60236998906072], {
            color: 'red',
            fillColor: '#f03',
            fillOpacity: 0.5,
            radius: 55
    ...
    $('#takeabsen').click(function (e) {
        ...
        var isPulang = "{{ $cek > 0 }}"; // Menandakan apakah ini absen pulang

        // Jika absen pulang, validasi field kegiatan harus diisi
        if (isPulang && !kegiatan) {
            Swal.fire({
                title: 'Error!',
                text: 'Field kegiatan harus diisi untuk absen pulang!',
                icon: 'error',
                confirmButtonText: 'OK'
            });
            return; // Hentikan eksekusi jika kegiatan kosong saat absen pulang
        }
