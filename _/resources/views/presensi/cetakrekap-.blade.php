...
<body>
    <section class="sheet padding-10mm">
        <div class="header-wrapper">
            <img src="{{ asset('public/assets/logo.jpeg') }}" style="margin-right: 45px;margin-left: 40px" alt="Logo">
            <div class="header">
        ...
        <div class="content">
            <div class="student-info">
                <p>MONITORING KEGIATAN MAHASISWA MAGANG PERIODE {{ $tahun }}</p><br/>
            ...
            @foreach ($presensi as $prs)
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @else
                            <img src="{{ asset('public/assets/img/kamera.png') }}" alt="" class="foto">
                        @endif
                    </td>
                    <td>
