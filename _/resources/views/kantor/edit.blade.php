                                ...
                                <div class="mb-3">
                                    <div class="input-icon">
                                        ...
                                        <input type="text" name="nm_kantor" id="nm_kantor"
                                            ...
                                            placeholder="Office Name" value="{{ $kantor->nm_kantor }}">
                                        @error('nm_kantor')
                                ...
                                <div class="mb-3">
                                    <div class="input-icon mb-3">
                                        ...
                                        <input type="number" name="radius" id="radius"
                                            ...
                                            placeholder="Office Radius" value="{{ $kantor->radius }}">
                                        @error('radius')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3">
                                    <div class="input-icon mb-3">
                                        ...
                                        <input type="text" name="location" id="location"
                                            ...
                                            value="{{ $kantor->location }}" readonly>
                                        @error('location')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3">
                                    <div class="input-icon mb-3">
                                        ...
                                        <input type="text" name="longitude" id="longitude"
                                            ...
                                            value="{{ $kantor->longitude }}" readonly>
                                        @error('longitude')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3">
                                    <div class="input-icon mb-3">
                                        ...
                                        <input type="text" name="latitude" id="latitude"
                                            ...
                                            value="{{ $kantor->latitude }}" readonly>
                                        @error('latitude')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
...
@push('myscript')
    <script>
        ...
        function mapReady() {
            ...
            L.marker([$('#latitude').val(), $('#longitude').val()]).addTo(markersGroup)
                .bindPopup($('#location').val())
                .openPopup();
